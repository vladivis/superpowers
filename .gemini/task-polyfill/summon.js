...
import { mkdirSync, writeFileSync, readFileSync, renameSync, rmSync, existsSync, createWriteStream, statSync, openSync, readSync, closeSync } from 'node:fs';
...
async function main() {
  ...
  const cmdPath = resolveSecureCommand(process.env.GEMINI_CMD || 'gemini');
  let exitCode = 1;
